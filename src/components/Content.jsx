  ...
  return (
    <div className="flex flex-col bg-gray-100 min-h-screen">
      ...
      <div className="flex flex-col gap-8 justify-center items-center pt-10">
        <div className="flex gap-4 justify-center border min-h-[50vh] w-4/5 p-2">
          <div className="w-1/2 min-h-[45vh] border p-2 flex flex-col gap-4">
          ...
          <div className="w-1/2 min-h-[45vh] border">right</div>
        </div>
        <div>Table</div>
      </div>
    </div>
